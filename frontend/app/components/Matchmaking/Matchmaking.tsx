...
const Matchmaking = () => {
  ...
  const [searchComplexity, setSearchComplexity] = useState(
    complexityOptions[0].name
  );
  ...
  return (
    <div className="mr-12 lg:flex-grow md:w-1/1.5 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex flex-col w-full">
        <div className="grid h-20 card bg-base-500 rounded-box place-items-center">
          <ButtonGroup className="h-full w-full">
            ...
            <Button
              ...
              variant="bordered"
              color={
                selectedComplexity && searchComplexity == 'Easy'
                  ? 'success'
                  : 'default'
              }
            ...
            <Button
              ...
              variant="bordered"
              color={
                selectedComplexity && searchComplexity == 'Medium'
                  ? 'warning'
                  : 'default'
              }
            ...
            <Button
              ...
              variant="bordered"
              color={
                selectedComplexity && searchComplexity == 'Hard'
                  ? 'danger'
                  : 'default'
              }
        ...
        <div className="grid h-20 card bg-base-500 rounded-box place-items-center w-full">
          <Select
      ...
      <WaitingModal
        ...
        handleRetry={() => handleSearch(searchComplexity, searchQuestionType)}
      ></WaitingModal>
    </div>
  );
};
